                    ...
                    <div className="row">             
                            ...
                            <div className="col-7 col-sm-5">
                                ...
                                <address>
                                    ...
                                    <i className="fa fa-envelope fa-lg"></i>Email: <a href="mailto:confusion@food.net">confusion@food.net</a>
                                </address>
                            </div>
                            <div className="col-12 col-sm-4 align-self-center">
                                    <div className="text-center">
                                        ...
                                        <a className="btn btn-social-icon btn-facebook" href="mailto:">
